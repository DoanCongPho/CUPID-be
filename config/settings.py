...
# Prefer getting SECRET_KEY from environment; fallback to a safe dev value.
SECRET_KEY = os.getenv(
    "SECRET_KEY",
    "django-insecure-itf(nhcmk&egmvraezvztw1(3btu-tmau@98mm4i&p8d3db=-3",
)
...
# Default to local sqlite for development; override via env for production if needed.
DATABASES = {
    "default": {
